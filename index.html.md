...
To print the the processed markdown, you can use the `read_pgs`
function. Here’s how:
...
By default, `read_pgs()` joins all pages. Pass `join=False` to get a
list of individual pages instead.
